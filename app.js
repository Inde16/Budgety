...
var budgetController = (function() {
    ...
    return {
        addItem: function(type , des , val) {
            ...
            // Create a nee item based on 'inc' or 'exp' type
            if (type === 'exp') {
        ...
        calculateBudget: function() {
            ...
            // Calculate total inconme and expenses
            calculateTotal('exp');
            calculateTotal('inc');
...
var controller = (function(budgetCtlr , UICtlr) {
    ...
    var setupEventListeners = function () {
        document.querySelector(DOM.inputButton).addEventListener('click', ctlrAddItem);
    ...
    var ctlrAddItem = function() {
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            // 2. Item to the budget controller
            newItem = budgetController.addItem(input.type, input.description, input.value);

            // 3. Add the new itme to the UI
